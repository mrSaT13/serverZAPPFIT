...
down_revision: str | None = "ab815ee3beae"
...
def upgrade() -> None:
    ...
    op.add_column(
        "activities",
        sa.Column(
            "max_speed", sa.DECIMAL(precision=20, scale=10), nullable=True, comment="Max speed seconds per meter (s/m)"
        ),
    )
    op.add_column("activities", sa.Column("max_power", sa.Integer(), nullable=True, comment="Max power (watts)"))
    op.add_column(
        "activities", sa.Column("normalized_power", sa.Integer(), nullable=True, comment="Normalized power (watts)")
    )
    op.add_column(
        "activities", sa.Column("average_hr", sa.Integer(), nullable=True, comment="Average heart rate (bpm)")
    )
    ...
    op.add_column(
        "activities", sa.Column("workout_feeling", sa.Integer(), nullable=True, comment="Workout feeling (0 to 100)")
    )
    op.add_column(
        "activities", sa.Column("workout_rpe", sa.Integer(), nullable=True, comment="Workout RPE (10 to 100)")
    )
    op.alter_column(
        "activities",
        "elevation_gain",
