...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "description", sa.String(length=2500), nullable=True, comment="Activity description (May include spaces)"
        ),
        sa.Column("distance", sa.Integer(), nullable=False, comment="Distance in meters"),
        sa.Column(
            "activity_type", sa.Integer(), nullable=False, comment="Gear type (1 - mountain bike, 2 - gravel bike, ...)"
        ),
        ...
        sa.Column(
            "calories", sa.Integer(), nullable=True, comment="The number of kilocalories consumed during this activity"
        ),
